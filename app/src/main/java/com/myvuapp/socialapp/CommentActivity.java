...
import com.myvuapp.socialapp.Adapter.CommentAdapter;
...
public class CommentActivity extends AppCompatActivity {
    ...
    private void addComment(){
        DatabaseReference reference = FirebaseDatabase.getInstance(Constants.DB_URL).getReference("Comments").child(postID);
    ...
    private void addNotifications(){
        DatabaseReference reference = FirebaseDatabase.getInstance(Constants.DB_URL).getReference("Notifications").child(publisherID);
