...
import com.myvuapp.socialapp.Adapter.UserAdapter;
...
public class FollowersActivity extends AppCompatActivity {
    ...
    private void getLikes() {
        DatabaseReference reference = FirebaseDatabase.getInstance(Constants.DB_URL).getReference("Likes")
                .child(id);
    ...
    private void getFollowing() {
        DatabaseReference reference = FirebaseDatabase.getInstance(Constants.DB_URL).getReference("Follow")
