...
import com.myvuapp.socialapp.ui.explore.ExploreFragment;
import com.myvuapp.socialapp.ui.home.HomeFragment;
...
public class StartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notificationItem = (BottomNavigationItemView) findViewById(R.id.inbox);
...
//         check new notification while remember previous notification count
        ...
        FirebaseDatabase.getInstance(Constants.DB_URL).getReference("Notifications").child(firebaseUser.getUid());
        final DatabaseReference reference = FirebaseDatabase.getInstance(Constants.DB_URL).getReference("Notifications").child(firebaseUser.getUid());
...
//                            qb.bindTarget(v).hide(false);
                            startActivity(new Intent(StartActivity.this,Inbox.class));
                            break;
