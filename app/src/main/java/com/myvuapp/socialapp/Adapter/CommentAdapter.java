...
import com.myvuapp.socialapp.Model.Comment;
import com.myvuapp.socialapp.Model.User;
import com.myvuapp.socialapp.R;
import com.myvuapp.socialapp.StartActivity;
...
public class CommentAdapter extends RecyclerView.Adapter<CommentAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Log.i("",comment + " " + comment.getComment() + " " +comment.getPublisherID());
                ...
                if (comment.getPublisherID().equals(firebaseUser.getUid())) {
                    ...
                    alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "Yes",
                            new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    FirebaseDatabase.getInstance(Constants.DB_URL).getReference("Comments").child(postID)
    ...
    private void getUserInfo(final ImageView imageProfile, final TextView username, final String publisherID){
        DatabaseReference reference = FirebaseDatabase.getInstance(Constants.DB_URL).getReference("Users").child(publisherID);
