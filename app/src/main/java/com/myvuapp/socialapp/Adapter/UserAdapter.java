...
//        }
        ...
        holder.btn_follow.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                if (holder.btn_follow.getText().toString().equals("follow")){
                    ...
                    FirebaseDatabase.getInstance(Constants.DB_URL).getReference().child("Follow").child(user.getUserID())
    ...
    private void isFollowing(final String userid, final Button btn_follow){
        DatabaseReference reference = FirebaseDatabase.getInstance(Constants.DB_URL).getReference()
