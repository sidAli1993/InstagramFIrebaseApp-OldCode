...
public class EditProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance(Constants.DB_URL).getReference("Users").child(currentUser.getUid());
    ...
    public void updateProfile(final Uri profile_uri_edit, final String self_intro_edited, final String username_edited){
        final DatabaseReference reference = FirebaseDatabase.getInstance(Constants.DB_URL).getReference().child("Users")
